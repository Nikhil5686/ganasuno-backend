...
const STATE_PATH = path.join(__dirname, "playlist-state-new.json");

const SONGS_PATH = path.join(__dirname, "songs-new.json");
...
const PLAYLIST_TITLE = "GanaSuno — Bhojpuri New";

const PLAYLIST_DESCRIPTION =
  "GanaSuno Bhojpuri New catalog — curated modern Bhojpuri music.";
...
async function main() {
  ...
  try {
    ...
    console.log("🎉 BHOJPURI NEW CATALOG COMPLETE");
