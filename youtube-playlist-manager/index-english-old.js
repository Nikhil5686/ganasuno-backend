...
const STATE_PATH = path.join(__dirname, "playlist-state-english-old.json");
const SONGS_PATH = path.join(__dirname, "songs-english-old.json");
...
const PLAYLIST_TITLE = "GanaSuno — English Old";
const PLAYLIST_DESCRIPTION = "GanaSuno English Old catalog — curated classic English music.";
...
async function searchSong(youtube, song) {
  const query = `${song.title} ${song.artist} English`;
  console.log(`\\n🔎 Searching: ${query}`);
