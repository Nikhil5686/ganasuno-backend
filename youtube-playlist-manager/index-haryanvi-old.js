...
const STATE_PATH = path.join(__dirname, "playlist-state-haryanvi-old.json");

const SONGS_PATH = path.join(__dirname, "songs-haryanvi-old.json");
...
const PLAYLIST_TITLE = "GanaSuno — Haryanvi Old";

const PLAYLIST_DESCRIPTION =
  "GanaSuno Haryanvi Old catalog — curated Haryanvi music.";
...
async function main() {
  ...
  try {
    ...
    console.log("🎉 HARYANVI OLD CATALOG COMPLETE");
