...
const STATE_PATH = path.join(__dirname, "playlist-state-punjabi-old.json");
const SONGS_PATH = path.join(__dirname, "songs-punjabi-old.json");
...
const PLAYLIST_TITLE = "GanaSuno — Punjabi Old";
const PLAYLIST_DESCRIPTION = "GanaSuno Punjabi Old catalog — curated Punjabi music.";
