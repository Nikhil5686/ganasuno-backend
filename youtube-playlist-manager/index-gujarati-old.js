...
const STATE_PATH = path.join(__dirname, "playlist-state-gujarati-old.json");
const SONGS_PATH = path.join(__dirname, "songs-gujarati-old.json");
...
const PLAYLIST_TITLE = "GanaSuno — Gujarati Old";
const PLAYLIST_DESCRIPTION = "GanaSuno Gujarati Old catalog — curated Gujarati music.";
