...
const STATE_PATH = path.join(__dirname, "playlist-state-english-new.json");
const SONGS_PATH = path.join(__dirname, "songs-english-new.json");
...
const PLAYLIST_TITLE = "GanaSuno — English New";
const PLAYLIST_DESCRIPTION = "GanaSuno English New catalog — curated English music.";
