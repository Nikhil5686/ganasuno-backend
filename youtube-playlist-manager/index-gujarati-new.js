...
const STATE_PATH = path.join(__dirname, "playlist-state-gujarati-new.json");
const SONGS_PATH = path.join(__dirname, "songs-gujarati-new.json");
...
const PLAYLIST_TITLE = "GanaSuno — Gujarati New";
const PLAYLIST_DESCRIPTION = "GanaSuno Gujarati New catalog — curated Gujarati music.";
...
async function searchSong(youtube, song) {
  const query = `${song.title} ${song.artist} Gujarati`;
  console.log(`\n🔎 Searching: ${query}`);
