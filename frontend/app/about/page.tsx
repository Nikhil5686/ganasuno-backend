...
export const metadata: Metadata = {
  ...
  description:
  "Discover GanaSuno, an Indian music discovery and curation platform founded by Nikhil Shukla and co-founded by Swayam Chondigra, focused on music across languages, regions, nostalgia, and different eras.",
};
      ...
      <section className="mb-14 space-y-5 text-stone-300 leading-relaxed">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            ...
            <p className="mt-1 text-sm font-medium text-amber-300">Founder</p>

            <p className="mt-2 text-sm text-stone-400">
              Founder of GanaSuno, contributing to the product direction,
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            ...
            <p className="mt-2 text-sm text-stone-400">
              Co-founder of GanaSuno, responsible for technology, development,
